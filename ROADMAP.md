...
| **Phase 3 — Intelligence** | ✅ Financial Statement Forecasting (projecting future P&L/Balance Sheet via driver linkages, see §6d) · ML forecasting (scikit-learn Random Forest/Gradient Boosting, not XGBoost/Prophet/LSTM — Vercel serverless has tight package-size/cold-start limits, see DEPLOYMENT.md) · Scenario Planning ("what-if" P&L/BS/CF recalculation) · Full AI Recommendation Engine (NLP insights, anomaly detection) · Churn/demand/bad-debt prediction |
