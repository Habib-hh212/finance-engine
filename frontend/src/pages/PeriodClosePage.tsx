      ...
      <TabPanel value={tab} index={3}>
        <Stack spacing={2}>
          <Typography variant="body2">
            Accrue an expense or revenue now and schedule its reversal, check whether a month is ready to close, and
            run the year-end close that zeroes revenue and expense into retained earnings. Balance sheet accounts
            need no separate "carry forward" step — the ledger already sums a company's entire posted history, so
            they carry forward automatically.
          </Typography>
          <Typography variant="subtitle2">Year-End Close</Typography>
          <Typography variant="body2" color="text.secondary">
            Posts one balanced entry zeroing every revenue and expense account's net activity for the range into the
            retained earnings account you pick. Asset, liability, and equity balances already carry forward
            automatically — only run this at the actual end of a fiscal year, not every month.
          </Typography>
        </Stack>
      </TabPanel>
    </Stack>
