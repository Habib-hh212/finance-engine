  ...
  return (
    <Stack spacing={3}>
      ...
      <Typography variant="caption" color="text.secondary">
        ...
        (commission), 194I (rent), 194Q (purchases), and similar sections. Set up the sections you actually deduct
        under below, then pick one when creating a{" "}
        <Link to="/receivables-payables" style={{ color: "inherit" }}>
          vendor bill
        </Link>{" "}
        — the deduction is split off automatically into whichever G/L account is tagged{" "}
        <code>tds_payable</code> on the Chart of Accounts, and the vendor's payable is reduced accordingly. Salary
        TDS (Section 192) works differently — it's slab-based per employee via payroll, not a flat rate here.
      </Typography>
