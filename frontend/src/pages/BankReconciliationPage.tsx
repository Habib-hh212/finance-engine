  ...
  return (
    <Stack spacing={3}>
      ...
      <Typography variant="caption" color="text.secondary">
        Upload a bank statement and it's matched automatically against what's already posted to this cash account --
        only when exactly one candidate has the same amount within a few days of the transaction date. Anything
        ambiguous or missing is left for you to match by hand, or points at a transaction (a bank fee, interest) that
        still needs a real posting on the Bookkeeping page.
      </Typography>
